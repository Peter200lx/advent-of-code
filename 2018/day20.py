...
class Room:
    ...
    def __init__(self, loc: Coord, from_dir=None, from_node=None):
        self.loc = loc
        self.dir_N = None
        self.dir_S = None
        self.dir_E = None
        self.dir_W = None
        if from_dir and from_node:
            setattr(self, "dir_" + self.REV_MAP[from_dir], from_node)

    def _add_dir(self, dir_c):
    ...
    def next_room(self, dir_c: str):
        ...
        setattr(self, next_name, Room(self._add_dir(dir_c), dir_c, self))
...
def distance_cost(path_to_now, cur_room, seen_rooms):
